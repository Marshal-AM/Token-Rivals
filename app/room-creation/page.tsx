        ...
        <div className="p-4">
          ...
          <div className="bg-gray-800 rounded-lg p-6 mb-6">
            ...
            <Button
              ...
              disabled={!roomId}
              className="w-full py-3 text-lg font-bold bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 rounded-lg transition-all duration-300 mb-4"
            >
              {copied ? (
                <>
